<template>
  <!--评论详情-->
    <div class="commentDetail">
      ...
      <div class="every only">
        ...
        <div class="word">
          <div class="start">
            ...
            <div class="fraction" v-if="$route.query.type!='话题详情'">
              <ul>
          ...
          <div class="other">
            ...
            <ul>
              <li><img src="../../assets/img/detail/evalhB.png" alt="">{{detail.replyNum||detail.replyVoList.length}}</li>
      ...
      <div class="list">
        <div class="tit">全部回复({{detail.replyNum?detail.replyNum:0}})</div>
          ...
          <div class="word">
            ...
            <div class="other">
              ...
              <ul>
                ...
                <li @click="$router.push({path:'/toEvaluate',query:{id:$route.query.id,mainId:item.mainId,type:$route.query.type,fatherId:item.id,fatherName:item.userName}})"><img src="../../assets/img/detail/evalhB.png" alt="">{{item.replyNum}}</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="foot" :style="{paddingBottom:!judgeBigScreen()?'0':'.2rem'}">
        <input type="text" placeholder="爱发言的人运气都不会太差..." v-model="value" @focus="getFocus">
        <h1 @click="replyFn">回复</h1>
      </div>
...
<script>
  ...
  import {getTopicCommentDetailAPI,saveTopicCommentAPI} from '@/api/xnew.js';
  ...
  import $ from 'jquery';
    export default {
      ...
      computed:{
        ...
        methods: {
          getDetail(){
            let api=this.$route.query.type=='话题详情'?getTopicCommentDetailAPI:commentDetailAPI;
            api(this.$route.query.mainId).then(res=>{
              if(res.data.status){
            ...
            if (true) {
              ...
              if(this.$route.query.type!='话题详情'){
                ...
                saveTopicCommentAPI({
                  ...
                  content: str,
                  fatherId: this.$route.query.mainId,
                  fabulousNum: this.detail.fabulousNum,
                  fatherName : this.detail.userName,
                  ...
                  console.log('话题评论',res.data.code)
                  if (res.data.code==0) {
                    self.$valert.show('回复成功');
                    self.value='';
                    self.getDetail();
