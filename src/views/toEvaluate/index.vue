<template>
  ...
  <div class="toEvaluate">
    ...
    <div class="evaluate">
      <div class="start" v-if="!$route.query.fatherName&&$route.query.type!='话题详情'">
        <h1>评分：</h1>
      ...
      <div class="send" @click="sendTo">提交留言</div>
    </div>
  </div>
</template>
...
<script>
  ...
  import {saveTopicCommentAPI,getTopicDetailAPI} from '@/api/xnew';
  ...
  export default {
    ...
    methods: {
      /*查详情*/
      getDetail() {
        let api = this.$route.query.type == '1' ? getBookDetailAPI : this.$route.query.type == '话题详情'?getTopicDetailAPI:getArticleDetailAPI;
