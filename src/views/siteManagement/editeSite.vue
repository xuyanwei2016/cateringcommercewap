<template>
    <div class='addSite'>
            ...
            <div class='area'>
                <div class='areaBox'>
                    ...
                    <div class='right' @click='cityChecked'>
                        <x-address title="" v-model="value" :list="this.addressData" :show.sync="showAddress" @on-shadow-change='changeAdd'></x-address>
                    </div>
                </div>
            </div>
            <div class='street'>
        ...
        <router-view  v-wechat-title="$route.meta.title">修改地址</router-view>
        ...
        getShoppingDetail(){
            ...
            getShoppingDetailAPI(data).then(res=>{
                if( res.data.code == 0 ){
                    ...
                    this.detailedText = data.detailed
                    this.info.name = data.receiver
                    this.info.phone = data.mobile
                    this.info.number = data.phone
                    this.info.email = data.email
                    let siteCode = data.addressCode.split(',')
                    this.value = siteCode
                }else{
                    this.$toast(res.data.msg)
                }
