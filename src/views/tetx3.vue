...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      weibo(){
        var sharesinastring='http://v.t.sina.com.cn/share/share.php?title='+'分享微博title'+'&url='+'http://http://192.168.2.242:8501/#/'+'&content=utf-8';
        window.open(sharesinastring,'newwindow','height=400,width=400,top=100,left=100');
      },
      qq(){

        var sharesinastring='http://connect.qq.com/widget/shareqq/index.html?url='+'http://http://192.168.2.242:8501/#/'+'&title=这里填写你要分享的文字内容&summary=&desc=&flash=&commonClient=true&site=QQ';
        window.open(sharesinastring,'newwindow','height=400,width=400,top=100,left=100');
      ...
      qqOther(){
        var p = {
          url: 'http://http://192.168.2.242:8501/#/', /*要分享的url*/
