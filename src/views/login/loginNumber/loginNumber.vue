<template>
    <div class='loginPas'>
        <div class='close'><img src="../../../assets/img/list/gb.png" alt="" @touchend='prev'></div>
        ...
        <div :class='btnData?"login":"loginNo"' @touchend='btnData?signInBtn():""'>登录</div>
...
<style scoped lang='less'>
    .loginPas{
        ...
        .title{
            ...
            text-align: left;
            text-align: left;
            margin:0.53rem 0 0.22rem 0.24rem;
        }
        .iphone,.verCode{
            width:3.45rem;
            height:0.63rem;
