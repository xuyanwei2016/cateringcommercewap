  ...
  <div class="bookDetail">
    ...
    <div class="bookInfo">
      ...
      <div class="InfoWord">
        ...
        <h3><img src="../../assets/img/detail/ege.png" alt="">{{detail.browseNum}}人阅读</h3>
        <p>{{detail.author}} 著</p>
        <div class="price">
    ...
    <div class="foot">
      <ul>
        ...
        <li class="bg" @click="payBtn"><img src="../../assets/img/detail/buy.png" alt="">购买</li>
      </ul>
    </div>
    ...
    <div class="Popup setFont" v-if="isShow" @click="isShow=false">
      <div class="buy" @click.stop="" v-if="isType==1">
        <div class="money">
          <h1>支付金额：</h1>
          <h2>￥{{detail.pricing ? detail.pricing.toFixed(2) : '0.00'}}</h2>
        </div>
        <ul>
...
<script>
  ...
  import {saveCollectionAPI,deleteCollectionAPI} from '../../api/xnew';
  ...
  export default {
    ...
    methods: {
      ...
      collection() {
        ...
        let API = this.isCollection ? deleteCollectionAPI:saveCollectionAPI;
        API({
          followId: this.id,
          followType: "2-1",//收藏对象类型 供查询用 2-1医著 2-2文章 2-3 课程（医道传承） 2-视频（医道传承） 2-5病例（医道传承） 医到传承-大师：51
          memberType:3
          }
        ).then(res => {
          if (res.data.status) {
