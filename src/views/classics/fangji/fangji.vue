<template>
    <div class='fangji' :style="{height:winH+'px'}">
        <div class='cup'>
            <div class='top'> 
                <div class='topLeft' @touchend='prev'>
                    <img src="@/assets/img/jingdian/icon_fanhui_black.png" alt="">
                </div>
                <div class='title'>方剂</div>
            </div>
            <div class='jdScreen'>
                <div class='screen' >
                    <div class='search'>
                        <input type="text" placeholder="请输入方名、症状等" v-model='value'>
...
<script>
    import fangji from '../../../components/list/fangji.vue'
