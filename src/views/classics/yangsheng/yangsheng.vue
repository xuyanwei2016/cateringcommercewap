<template>
    <div class='yangsheng' :style="{height:winH+'px'}">
        <div class='cup'>
            <div class='top'> 
                <div class='topLeft' @touchend='prev'>
                    <img src="@/assets/img/jingdian/icon_fanhui_black.png" alt="">
                </div>
                <div class='title'>养生保健</div>
            </div>
            <div class='jdScreen'>
                <div class='screen' >
                    <div class='search'>
                        <input type="text" placeholder="请输入文章名、症状等" v-model='value' >
...
import yangsheng from '../../../components/list/yangsheng.vue'
import yian from '../../../components/list/yian.vue'
    ...
    .yangsheng{
       ...
       .top{
           ...
           .topLeft{
               ...
               height:0.2rem;
               float:left;
               margin:0.165rem 1.04rem 0  0.155rem;
               img{
                width:0.1rem;
                height:0.17rem;
            }
