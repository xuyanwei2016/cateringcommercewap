          ...
          <div class="word">
            ...
            <div class="other">
              ...
              <ul>
                ...
                <li @click="$router.push({path:'/toLenEva',query:{id:$route.query.id,mainId:item.mainId,type:$route.query.type,fatherId:item.id,fatherName:item.userName}})"><img src="@/assets/img/detail/evalhB.png" alt="">{{item.replyNum}}</li>
              </ul>
            </div>
          </div>
        </div>
...
<script>
  ...
  import {lenCommentDetailAPI,saveLenCommentAPI} from '@/api/detail.js';
  ...
  import {agreeAPI} from '@/api/list.js';
    export default {
      ...
      computed:{
        ...
        methods: {
          getDetail(){
            // let api=this.$route.query.type=='话题详情'?getTopicCommentDetailAPI:lenCommentDetailAPI;
            lenCommentDetailAPI(this.$route.query.mainId).then(res=>{
              if(res.data.status){
