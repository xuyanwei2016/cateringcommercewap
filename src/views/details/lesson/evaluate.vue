<template>
  ...
  <div class="toEvaluate">
    <commentHeader @sendFrom="sendTo"></commentHeader>
    <div class="evaluate">

      <div class="start" v-if="$route.query.type!='话题详情'">
        <h1>评分：</h1>
...
<script>
  ...
  import {saveLenCommentAPI, getlessonDetailAPI} from '@/api/detail.js';
  ...
  export default {
    ...
    methods: {
      /*查详情*/
      getDetail() {
        getlessonDetailAPI(this.$route.query.id).then(res => {
          if (res.data.status) {
