<template>
    <div class='yianCom'>
        <div class='yianBorder' >
            <div class='yianCenter' v-for="(item,index) in list" :key="index" @click="linkDetail(item)">
...
export default {
    ...
    methods: {
        ...
        linkDetail(item){
            ...
            this.$router.push({path:'/read',query:{id:item.id}});
        },
        // linkDetail(value){
        //     this.$emit('linkDetail',value);
        // },
    }
}
</script>
